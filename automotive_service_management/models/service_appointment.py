...
class ServiceAppointment(models.Model):
    ...
    # fields for automotive service appointment #T00470
    ...
    total_cost = fields.Integer(
        string="Total Cost", compute="_compute_total_cost", readonly="True"
    )
    ...
    # button for change state #T00470
    def button_appointed(self):
        """button for change state into appointed #T00470"""
    ...
    def button_in_service(self):
        ...
        otherwise it is assign work to the mechanic #T00470"""
        for mechanic in self.assigned_mechanic_id:
            if mechanic.work_assigned:
                raise ValidationError(
                    f"{mechanic.name} is busy please select another one or wait till finish work."
                )
            else:
    ...
    def button_serviced(self):
        ...
        serviced car after that send mail to the customer for pick up the car #T00470"""
    ...
    # create inherit method for sequence #T00470
    @api.model
    ...
    # name_get method for concate the name and appointment number #T00470
    ...
    # name_search method for search many2one field #T00470
    @api.model
    ...
    # _compute_delivery_date for calculate estimate delivery date of car service #T00470
    @api.depends("appointment_date")
    def _compute_delivery_date(self):
        """calculate delivery date from days given in system parameter #T00470"""
    ...
    # action_send_mail for send mail to customer after the service is completed #T00470
    def action_send_mail(self):
        """this method is for send mail to customer after service is completed of car #T00470"""
    ...
    # _compute method for calculate total cost of the taken serviced #T00470
