...
class TestServiceAppointment(TransactionCase):
    ...
    def setUp(self):
        ...
        # create record for appointment_01 #T00470
        ...
        # create record for mechanic #T00470
        self.mechanic_02 = self.env["automotive.mechanic"].create({"name": "Peter"})
        # create record for appointment_02 #T00470
        ...
        # create record for appointment_03 #T00470
        ...
        # assertRaises for handle ValidationError #T00470
        with self.assertRaises(ValidationError):
            self.appointment_03.button_in_service()

    # method for check the output of function #T00470
