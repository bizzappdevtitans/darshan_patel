...
class StockMove(models.Model):
    ...
    def _get_new_picking_values(self):
        ...
        delivery_values["delivery_description"] = self.group_id.sale_id.delivery_description
    ...
    def _prepare_procurement_values(self):
        ...
        """pass field value for purchase order"""
        res["purchase_description"] = self.group_id.sale_id
        """pass field value for manufacturing order"""
        res['manufacturing_description'] = self.sale_line_id.order_id.manufacturing_description
        return res
